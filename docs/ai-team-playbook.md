...
| 6 | **Flash** *(Gemini 3.6 High / Med via agy/Antigravity)* | Laptop | Full-Stack Coder | Full-stack coding (FE, BE, APIs, tooling) across all 8 repos + general agy lane. Invoked via `/next` or interactive `agy`. | *(issued via GitHub label — `agy-tasks.txt` retired, web-jam-tools#249)* |
