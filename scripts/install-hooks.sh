...
SESSION_START_HOOKS=(notes-sync-reminder.sh check-install-hooks-drift.sh memory-cleanup-reminder.sh flash-issues-reminder.sh backlog-groom-reminder.sh)
