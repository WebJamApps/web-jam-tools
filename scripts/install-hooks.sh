...
DENY_RULES=(
  ...
  # GitHub MCP irreversible tool denies (R-9 & R-24)
...
ASK_RULES=(
  ...
  'mcp__.*__create_branch'
  'mcp__.*__create_or_update_file'
  'mcp__.*__create_pull_request'
  'mcp__.*__create_repository'
  'mcp__.*__fork_repository'
  'mcp__.*__issue_write'
  'mcp__.*__pull_request_review_write'
  'mcp__.*__push_files'
  'mcp__.*__request_copilot_review'
  'mcp__.*__sub_issue_write'
  'mcp__.*__update_pull_request'
  'mcp__.*__update_pull_request_branch'
  'mcp__.*__run_secret_scanning'
)
