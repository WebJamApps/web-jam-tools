...
| 3  | Add repo normalization                                                | Epic #1         | Flash-High | High     | web-jam-tools | Unit tests                               | PR merges                                                           |
| 4  | Add tier normalization                                                | Epic #1         | Flash High | High     | NotARealRepo  | Unit tests                               | PR merges                                                           |
| 5  | Josh: review the validator output                                     | Epic #1         | Flash High | High     | web-jam-tools | Unit tests                               | PR merges                                                           |
| 6  | Add priority validation                                               | Epic #1         | Flash High | Critical | web-jam-tools | Unit tests                               | PR merges                                                           |
...
| 9  | Add cross-repo child example                                          | Epic #1         | Flash High | High     | JaMmusic      | Unit tests                               | PR merges                                                           |
