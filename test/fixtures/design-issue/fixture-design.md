# WebSocket Gateway Notifications — Design
...
- Automated database schema migration. Migrations remain manual via migration scripts.
- Third-party payment gateway webhook integration, owned by web-jam-back#120.
